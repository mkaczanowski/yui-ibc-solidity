...
library CanonicalVote {
  ...
  //struct definition
  struct Data {
    TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.SignedMsgType Type;
    int64 height;
    int64 round;
  ...
  function _read_Type(
    ...
    TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.SignedMsgType x = TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.decode_SignedMsgType(tmp);
    if (isNil(r)) {
      counters[1] += 1;
    } else {
      r.Type = x;
    ...
    returns (uint)
  {
    ...
    int64 _enum_Type = TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(r.Type);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(r.Type));
    e += 1 + 8;
    e += 1 + 8;
...
library CommitSig {
  ...
  //struct definition
  struct Data {
    TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.BlockIDFlag block_id_flag;
    bytes validator_address;
    Timestamp.Data timestamp;
    bytes signature;
  }
  ...
  function _read_block_id_flag(
     ...
     */
    (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
    TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.BlockIDFlag x = TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.decode_BlockIDFlag(tmp);
    if (isNil(r)) {
      counters[1] += 1;
    } else {
      r.block_id_flag = x;
    ...
    returns (uint)
  {
    ...
    int64 _enum_block_id_flag = TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.encode_BlockIDFlag(r.block_id_flag);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS.encode_BlockIDFlag(r.block_id_flag));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.validator_address.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(Timestamp._estimate(r.timestamp));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    return e;
...
library TENDERMINT_LIGHT_PROTO_GLOBAL_ENUMS {
  ...
  function encode_BlockIDFlag(BlockIDFlag x) internal pure returns (int64) {
  ...
  // Solidity enum encoder
  function encode_SignedMsgType(SignedMsgType x) internal pure returns (int64) {
