...
library IbcLightclientsIbft2V1TestStruct {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 1) {
        ...
        pointer += _read_chain_id_2(pointer, bs, r, counters);
      }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.chain_id_2, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.chain_id_2).length);
    return e;
  }
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.chain_id_2 = input.chain_id_2;
